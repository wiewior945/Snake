...
class Snake(py_environment.PyEnvironment):
    ...
    def _step(self, action):
        ...
        print("Head: " + str(colisionOutput[1]))
    ...
    def colision(self):
        ...
        elif (self.snake.count(head) > 0 or head[0] < 0 or head[1] >= self.boardSize or head[1] < 0 or head[1] >= self.boardSize):
            self.done = True
            return surroundings, head, -1000  # kolizja więc nie potrzeba dalej rysować, zwraca -1000 punktów jako koniec gry
